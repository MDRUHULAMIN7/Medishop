...
export function WhatsAppButton() {
  ...
  return (
    <aside
      ...
      className="fixed bottom-20 md:bottom-6 right-4 sm:right-6 z-50 flex items-center gap-2 group"
    >
      ...
      <span className="hidden sm:inline-block opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0 bg-foreground text-background text-xs font-bold px-3 py-1.5 rounded-xl shadow-lg whitespace-nowrap pointer-events-none">
        {isBn ? 'হোয়াটসঅ্যাপে চ্যাট করুন (২৪/৭)' : 'Chat on WhatsApp (24/7)'}
      </span>
      ...
      <a
        ...
        aria-label={isBn ? 'হোয়াটসঅ্যাপে চ্যাট করুন' : 'Chat on WhatsApp'}
        className="relative flex h-13 w-13 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-all duration-300 hover:scale-110 hover:shadow-2xl active:scale-95 group"
      >
